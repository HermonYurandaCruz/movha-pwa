...
export default function AdminListStands() {
  ...
  const loadUserData = () => {
    const UsersRef = firebase.firestore().collection('users').where('estado', '==', 1);
                            ...
                            <Image
                              ...
                              />
                                ...
                                <View style={{marginStart:8}}>
                                        ...
                                        <TouchableOpacity style={{paddingHorizontal:4,paddingVertical:3, backgroundColor:"#F23232", borderRadius:8}} onPress={()=>updateStatus(users.id)}>
                                         <Text style={{color:"#FFFFFF"}}>Remover Stand</Text> 
                                        </TouchableOpacity>
                                </View>
                        </View>
